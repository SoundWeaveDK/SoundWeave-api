...
import { createPodcast, deletePodcast, findSinglePodcast, getAllUsersFollowPodcasts, updatePodcast } from "../services/podcast-service";
...
export async function readSinglePodcastHandler(request: FastifyRequest<{ Params: podcastSchema }>, reply: FastifyReply) {
...
export async function readFollowingPodcastsHandler(request: FastifyRequest<{ Params: podcastSchema }>, reply: FastifyReply) {
    const param = request.params;
    try {
